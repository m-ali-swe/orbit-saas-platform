  ...
  return (
    <header className='sticky top-0 z-50'>
      <div className='flex  h-8 justify-center items-center bg-gray-800 gap-2 text-center text-xs text-white'>
        <span className='hidden text-gray-400 sm:inline'>Streamline your workflow and boost your productivity.</span>
        
       <span className='flex items-center text-gray-200 gap-1'>Get started for free 
        <svg width="100%" height="100%" viewBox="0 0 20 20" fill="none" className='size-4' xmlns="http://www.w3.org/2000/svg">
...
<div className='flex w-full absolute backdrop-blur-sm justify-between gap-3 b-red-400 items-center lg:px-20 md:px-14 px-12 py-2'>
...
<nav className='hidden text-gray-800 sm:flex lg:gap-10 md:gap-8 gap-5 text-center items-center'>
    ...
    <span>Updates</span>
    <span>Help</span>
    <button className='rounded-lg w-28 h-10 bg-gray-800 text-white'>Get for free</button>
</nav>
