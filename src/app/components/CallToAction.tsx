...
export default function CallToAction() {
  ...
  return (
    <div
      ref={first}
      className="flex lg:mt-52 mt-16 sm:mt-10 sm:h-[400px] h-[300px] lg:h-[360px] relative px-8 flex-col gap-5 items-center bg-gradient-to-b from-white to-[#D2DCFF] "
    >
      <h2 className="sm:text-5xl text-3xl font-bold text-center">
        Sign up for free today
      </h2>
      <p className="text-center w-full md:w-[60%] lg:w-[50%] ">
